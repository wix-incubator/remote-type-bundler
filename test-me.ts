...
(async function main() {
    ...
    await bundle('@wix/site-members@1.12.0', './test-me-results/test-me-bundle-site-members.d.ts', {cdn: CdnType.JSDELIVR});
    ...
    await bundle('@wix/site-bookings@1.10.0', './test-me-results/test-me-bundle-site-bookings.d.ts', {cdn: CdnType.JSDELIVR});
